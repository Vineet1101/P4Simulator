...
//"Set default action for a match table: table_set_default <table name> <action
//name> <action parameters>"
unsigned int const TABLE_SET_DEFAULT = 0;

//"Add entry to a match table: table_add <table name> <action name> <match
//fields> => <action parameters> [priority]"
...
//"Add entry to a match table: table_modify <table name> <action name> <entry
...
//"Configure rates for an entire meter array: meter_array_set_rates <name>
//<rate_1>:<burst_1> <rate_2>:<burst_2> ..."
unsigned int const METER_ARRAY_SET_RATES = 7;

//"Configure rates for a meter: meter_set_rates <name> <index>
//<rate_1>:<burst_1> <rate_2>:<burst_2> ..."
...
//"Clear all entries in a match table (direct or indirect), but not the default
//entry: table_clear <table name>"
...
//"Display some information about a table entry: table_dump_entry <table name>
//<entry handle>"
