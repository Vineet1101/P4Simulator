...
uint64_t P4SwitchNetDeviceCore::packet_id = 0;
// int P4SwitchNetDeviceCore::thrift_port = 8090; // @TODO - Remove this

P4SwitchNetDeviceCore::P4SwitchNetDeviceCore(P4NetDevice* netDevice){
...
int
P4SwitchNetDeviceCore::init(int argc, char* argv[])
{
    NS_LOG_FUNCTION(this);
    int status = 0;
    ...
    if (P4GlobalVar::g_populateFlowTableWay == LOCAL_CALL) {
        ...
        NS_LOG_ERROR("ERROR: P4 Model switch init failed in P4SwitchNetDeviceCore::init.");
        return -1;
    }
    ...
    if (status != 0)
    {
        NS_LOG_LOGIC("ERROR: P4 Model switch init failed in P4SwitchNetDeviceCore::init.");
        std::exit(status);
    }
    return 0;
}
...
int
P4SwitchNetDeviceCore::InitFromCommandLineOptionsLocal(int argc, char* argv[], bm::TargetParserBasic* tp)
{
...
void
P4SwitchNetDeviceCore::run_cli(const std::string& commandsFile)
{
    int port = get_runtime_port();
    bm_runtime::start_server(this, port);
    start_and_return();
...
int
P4SwitchNetDeviceCore::receive_(port_t port_num, const char* buffer, int len)
{
    NS_LOG_FUNCTION(this);
    return 0;
}
...
void
P4SwitchNetDeviceCore::start_and_return_()
{
    NS_LOG_FUNCTION("p4_switch has been start");
    check_queueing_metadata();
}

void P4SwitchNetDeviceCore::check_queueing_metadata()
{
...
int
P4SwitchNetDeviceCore::ReceivePacket(Ptr<Packet> packetIn,
                               int inPort,
                               uint16_t protocol,
...
void
P4SwitchNetDeviceCore::enqueue(port_t egress_port,
...
void
P4SwitchNetDeviceCore::parser_ingress_processing(Ptr<Packet> packetIn)
{
    NS_LOG_FUNCTION(this);
...
void
P4SwitchNetDeviceCore::egress_deparser_processing()
{
...
// P4SwitchNetDeviceCore::get_bm_packet(Ptr<Packet> ns_packet)
// {
//     NS_LOG_FUNCTION(this);
...
std::unique_ptr<bm::Packet> P4SwitchNetDeviceCore::get_bm_packet(Ptr<Packet> ns_packet)
{
    NS_LOG_FUNCTION(this);
...
Ptr<Packet>
P4SwitchNetDeviceCore::get_ns3_packet(std::unique_ptr<bm::Packet> bm_packet)
{
...
Ptr<Packet>
P4SwitchNetDeviceCore::get_ns3_packet(std::unique_ptr<bm::Packet> bm_packet, PacketInfo* pkts_info)
{
    // Create a new ns3::Packet using the data buffer
    char* bm_buf = bm_packet.get()->data();
    size_t len = bm_packet.get()->get_data_size();
...
// int
// P4SwitchNetDeviceCore::set_egress_priority_queue_depth(size_t port,
//                                                  size_t priority,
...
// int
// P4SwitchNetDeviceCore::set_egress_queue_depth(size_t port, const size_t depth_pkts)
// {
...
// int
// P4SwitchNetDeviceCore::set_all_egress_queue_depths(const size_t depth_pkts)
// {
...
// int
// P4SwitchNetDeviceCore::set_egress_priority_queue_rate(size_t port,
//                                                 size_t priority,
...
// int
// P4SwitchNetDeviceCore::set_egress_queue_rate(size_t port, const uint64_t rate_pps)
// {
...
// int
// P4SwitchNetDeviceCore::set_all_egress_queue_rates(const uint64_t rate_pps)
// {
