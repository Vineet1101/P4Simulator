...
#ifndef P4_SWITCH_NETDEVICE_CORE_H
#define P4_SWITCH_NETDEVICE_CORE_H
 ...
 */
class P4SwitchNetDeviceCore : public bm::Switch
{
  public:
    // by default, swapping is off
    P4SwitchNetDeviceCore(P4SwitchNetDevice* netDevice);

    ~P4SwitchNetDeviceCore();
    ...
    /**
     * This function P4SwitchNetDeviceCore::get_bm_packet converts the NS-3 packet ns_packet to bm::Packet
    ...
    P4SwitchNetDeviceCore(const P4SwitchNetDeviceCore&) = delete;
    P4SwitchNetDeviceCore& operator=(const P4SwitchNetDeviceCore&) = delete;
    P4SwitchNetDeviceCore(P4SwitchNetDeviceCore&&) = delete;
    P4SwitchNetDeviceCore&& operator=(P4SwitchNetDeviceCore&&) = delete;
...
#endif // !P4_SWITCH_NETDEVICE_CORE_H