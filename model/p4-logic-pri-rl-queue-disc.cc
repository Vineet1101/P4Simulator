...
NSQueueingLogicPriRLQueueDisc::NSQueueingLogicPriRLQueueDisc()
{
    ...
    NS_LOG_DEBUG("NSQueueingLogicPriRLQueueDisc default constructor with "
                 << m_nbPorts << " ports and " << m_nbPriorities << " priorities");
}
...
void
NSQueueingLogicPriRLQueueDisc::InitializeParams(void)
{
