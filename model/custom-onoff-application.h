 ...
 * \defgroup onoff CustomOnOffApplication
 *
...
public:
  ...
  /**
   * \brief Set the custom header to be added to packets.
   * \param header The custom header.
   */
  void SetCustomHeader (const CustomHeader &header);
...
private:
  ...
  CustomHeader m_customHeader; //!< Custom header to add to outgoing packets.
