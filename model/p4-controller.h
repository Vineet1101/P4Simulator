...
class P4Controller : public Object
{
  public:
    ...
    uint32_t GetTableEntryCount(uint32_t index, const std::string& tableName);
     ...
     */
    void DeleteFlowEntry(uint32_t index, const std::string& tableName, bm::entry_handle_t handle);
    ...
    void PrintEntryFromKey(uint32_t index,
                           const std::string& tableName,
                           const std::vector<bm::MatchKeyParam>& matchKey);
    void PrintIndirectEntryFromKey(uint32_t index,
                                   const std::string& tableName,
                                   const std::vector<bm::MatchKeyParam>& matchKey);
    void PrintIndirectWsEntryFromKey(uint32_t index,
                                     const std::string& tableName,
                                     const std::vector<bm::MatchKeyParam>& matchKey);
    ...
    void WriteCounters(uint32_t index,
                       const std::string& tableName,
                       bm::entry_handle_t handle,
                       uint64_t bytes,
                       uint64_t packets);
    ...
    void WriteCounter(uint32_t index,
     ...
     */
    void GetMeterRates(uint32_t index, const std::string& tableName, bm::entry_handle_t handle);
     ...
     */
    void ResetMeterRates(uint32_t index, const std::string& tableName, bm::entry_handle_t handle);
     ...
     * @param meterIndex Index within the meter array.
     */
    void GetMeterRates(uint32_t index, const std::string& meterName, size_t meterIndex);
     ...
     * @param meterIndex Index within the meter array.
     */
    void ResetMeterRates(uint32_t index, const std::string& meterName, size_t meterIndex);

    // ======= Register  Functions  =======
    void RegisterRead(uint32_t index,
                      const std::string& registerName,
                      size_t regIndex,
                      bm::Data* value);

    void RegisterWrite(uint32_t index,
                       const std::string& registerName,
                       size_t regIndex,
                       const bm::Data& value);
    ...
    void RegisterWriteRange(uint32_t index,
                            const std::string& registerName,
                            size_t startIndex,
                            size_t endIndex,
                            const bm::Data& value);
     ...
     */
    void ParseVsetAdd(uint32_t index, const std::string& setName, const bm::ByteContainer& value);
    ...
    /**
     * @brief Swaps the currently active configuration with the newly loaded one on the specified
     * switch.
     * @param index The switch index.
     */
