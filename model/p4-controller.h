...
class P4Controller : public Object
{
  public:
     ...
     */
    void ClearFlowTableEntries(uint32_t index,
 ...
 * @param priority Optional priority value (used for ternary/LPM matches). Default is -1.
 */
void AddFlowEntry(uint32_t index,
                  const std::string& tableName,
...
/**
 * @brief Sets the default action for a match-action table on the specified switch.
 * @param index The switch index.
 * @param tableName The name of the table.
 * @param actionName The name of the default action.
 * @param actionData The action parameters.
 */
void SetDefaultAction(uint32_t index,
                      const std::string& tableName,
                      const std::string& actionName,
                      bm::ActionData&& actionData);

/**
 * @brief Resets the default action for a match-action table to its original state.
 * @param index The switch index.
 * @param tableName The name of the table.
 */
...
/**
 * @brief Deletes a specific flow entry from a match-action table on the specified switch.
 * @param index The switch index.
 * @param tableName The name of the table.
 * @param handle The handle of the entry to delete.
 */
void DeleteFlowEntry(uint32_t index,
                     const std::string& tableName,
 ...
 */
void ModifyFlowEntry(uint32_t index,
                     const std::string& tableName,
                     bm::entry_handle_t handle,
                     const std::string& actionName,
                     bm::ActionData actionData);
...
/**
 * @brief Sets a timeout (TTL) for a specific flow entry in a match-action table.
 * @param index The switch index.
 * @param tableName The name of the table.
 * @param handle The entry handle.
 * @param ttlMs The TTL value in milliseconds.
 */
void SetEntryTtl(uint32_t index,
                 const std::string& tableName,
                 bm::entry_handle_t handle,
                 unsigned int ttlMs);
 ...
 */
void AddActionProfileMember(uint32_t index,
 ...
 */
void DeleteActionProfileMember(uint32_t index,
                               const std::string &profileName,
 ...
 * @param actionData The new action parameters.
 */
void ModifyActionProfileMember(uint32_t index,
                               const std::string &profileName,
                               bm::ActionProfile::mbr_hdl_t memberHandle,
                               const std::string &actionName,
                               bm::ActionData &&actionData);
     ...
     */
    void CreateActionProfileGroup(uint32_t index,
                                  const std::string& profileName,
     ...
     */
    void DeleteActionProfileGroup(uint32_t index,
                                  const std::string& profileName,
     ...
     */
    void AddMemberToGroup(uint32_t index,
                          const std::string& profileName,
                          bm::ActionProfile::mbr_hdl_t memberHandle,
                          bm::ActionProfile::grp_hdl_t groupHandle);
/**
 ...
 */
void RemoveMemberFromGroup(uint32_t index,
                           const std::string& profileName,
                           bm::ActionProfile::mbr_hdl_t memberHandle,
                           bm::ActionProfile::grp_hdl_t groupHandle);
 ...
 * @param profileName Name of the action profile
 */
void GetActionProfileMembers(uint32_t index,
                             const std::string& profileName);
 ...
 */
void GetActionProfileMember(uint32_t index,
                            const std::string& profileName,
                            bm::ActionProfile::mbr_hdl_t memberHandle);
/**
 ...
 * @param profileName Name of the action profile
 */
void GetActionProfileGroups(uint32_t index,
                            const std::string& profileName);
 ...
 */
void GetActionProfileGroup(uint32_t index,
                           const std::string& profileName,
                           bm::ActionProfile::grp_hdl_t groupHandle);
 ...
 */
void AddIndirectEntry(uint32_t index,
                      const std::string& tableName,
                      const std::vector<bm::MatchKeyParam>& matchKey,
                      bm::ActionProfile::mbr_hdl_t memberHandle,
 ...
 */
void ModifyIndirectEntry(uint32_t index,
                         const std::string& tableName,
 ...
 */
void DeleteIndirectEntry(uint32_t index,
                                  const std::string& tableName,
                                  bm::entry_handle_t entryHandle);
/**
 ...
 */
void SetIndirectEntryTtl(uint32_t index,
                         const std::string& tableName,
                         bm::entry_handle_t handle,
                         unsigned int ttlMs);
 ...
 */
void SetIndirectDefaultMember(uint32_t index,
                              const std::string& tableName,
                              bm::ActionProfile::mbr_hdl_t memberHandle);
 ...
 * @param tableName Match table name
 */
void ResetIndirectDefaultEntry(uint32_t index,
                               const std::string& tableName);
 ...
 */
void AddIndirectWsEntry(uint32_t index,
                        const std::string& tableName,
                        const std::vector<bm::MatchKeyParam>& matchKey,
                        bm::ActionProfile::grp_hdl_t groupHandle,
                        bm::entry_handle_t* outHandle,
 ...
 */
void ModifyIndirectWsEntry(uint32_t index,
                           const std::string& tableName,
                           bm::entry_handle_t handle,
                           bm::ActionProfile::grp_hdl_t groupHandle);
 ...
 */
void SetIndirectWsDefaultGroup(uint32_t index,
                               const std::string& tableName,
                               bm::ActionProfile::grp_hdl_t groupHandle);
...
void PrintEntry(uint32_t index, const std::string& tableName, bm::entry_handle_t handle);
...
void PrintIndirectWsDefaultEntry(uint32_t index, const std::string& tableName);
void PrintEntryFromKey(uint32_t index, const std::string& tableName, const std::vector<bm::MatchKeyParam>& matchKey);
void PrintIndirectEntryFromKey(uint32_t index, const std::string& tableName, const std::vector<bm::MatchKeyParam>& matchKey);
void PrintIndirectWsEntryFromKey(uint32_t index, const std::string& tableName, const std::vector<bm::MatchKeyParam>& matchKey);


// ================= Counter Operations ===================

void ReadCounters(uint32_t index, const std::string& tableName, bm::entry_handle_t handle);
void ResetCounters(uint32_t index, const std::string& tableName);
void WriteCounters(uint32_t index, const std::string& tableName, bm::entry_handle_t handle, uint64_t bytes, uint64_t packets);
void ReadCounter(uint32_t index, const std::string &counterName, size_t counterIndex);
void ResetCounter(uint32_t index, const std::string &counterName);
void WriteCounter(uint32_t index, const std::string &counterName, size_t counterIndex,
 ...
 */
void SetMeterRates(uint32_t index,
                   const std::string &tableName,
                   bm::entry_handle_t handle,
 ...
 */
void GetMeterRates(uint32_t index,
                   const std::string &tableName,
                   bm::entry_handle_t handle);
 ...
 */
void ResetMeterRates(uint32_t index,
                     const std::string &tableName,
                     bm::entry_handle_t handle);
 ...
 */
void SetMeterArrayRates(uint32_t index,
 ...
 */
void ParseVsetAdd(uint32_t index,
 ...
 */
void ParseVsetRemove(uint32_t index,
                     const std::string &setName,
                     const bm::ByteContainer &value);
 ...
 * @param setName Name of the parse value set.
 */
void ParseVsetGet(uint32_t index,
                  const std::string &setName);
 ...
 * @param setName Name of the parse value set.
 */
void ParseVsetClear(uint32_t index,
                    const std::string &setName);
...
/**
 * @brief Resets the runtime state of the specified switch to its initial configuration.
 * @param index The switch index.
 */
...
/**
 * @brief Swaps the currently active configuration with the newly loaded one on the specified switch.
 * @param index The switch index.
 */
...
/**
 * @brief Retrieves and logs the MD5 hash of the current runtime configuration.
 * @param index The switch index.
 */
