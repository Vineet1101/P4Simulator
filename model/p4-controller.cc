...
void P4Controller::ViewP4SwitchFlowTableInfo(
    size_t index) // view p4 switch flow table, counter, register, meter info
{
  if (m_p4Switches[index] != NULL)
    ...
    std::cerr << "Call ViewP4SwitchFlowTableInfo(" << index
              << "): P4SwitchInterface Pointer is Null" << std::endl;
  }
}
...
void P4Controller::SetP4SwitchViewFlowTablePath(
  ...
  if (m_p4Switches[index] != NULL)
    ...
    std::cerr << "Call SetP4SwitchViewFlowTablePath(" << index
              << "): P4SwitchInterface Pointer is Null" << std::endl;
  }
}
...
void P4Controller::SetP4SwitchFlowTablePath(size_t index,
  ...
  if (m_p4Switches[index] != NULL)
    ...
    std::cerr << "Call SetP4SwitchFlowTablePath(" << index
              << "): P4SwitchInterface Pointer is Null" << std::endl;
  }
}
