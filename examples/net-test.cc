...
NS_LOG_COMPONENT_DEFINE("NetTest");
...
main(int argc, char* argv[])
{
    ...
    Names::Add("R0", routers.Get(0));
    Names::Add("R1", routers.Get(1));
    Names::Add("R2", routers.Get(2));
    Names::Add("H0", hosts.Get(0));
