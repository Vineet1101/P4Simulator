...
main(int argc, char* argv[])
{
    ...
    std::string p4JsonPath =
        "/home/p4/workdir/ns3.39/contrib/p4sim/examples/p4src/source_routing/source_routing.json";
    // std::string flowTableDirPath =
    //     "/home/p4/workdir/ns3.39/contrib/p4sim/examples/p4src/source_routing/";
    std::string topoInput =
        "/home/p4/workdir/ns3.39/contrib/p4sim/examples/p4src/source_routing/topo.txt";
