...
void
P4PointToPointHelper::SetQueue (std::string type, std::string n1, const AttributeValue &v1,
...
void
P4PointToPointHelper::EnablePcapInternal (std::string prefix, Ptr<NetDevice> nd, bool promiscuous,
...
void
P4PointToPointHelper::EnableAsciiInternal (Ptr<OutputStreamWrapper> stream, std::string prefix,
  ...
  if (stream == nullptr)
    {
      ...
      //
      asciiTraceHelper.HookDefaultReceiveSinkWithoutContext<CustomP2PNetDevice> (device, "MacRx",
                                                                                 theStream);
      ...
      asciiTraceHelper.HookDefaultDropSinkWithoutContext<CustomP2PNetDevice> (device, "PhyRxDrop",
                                                                              theStream);
