 ...
 */
#ifndef P4_POINT_TO_POINT_HELPER_H
#define P4_POINT_TO_POINT_HELPER_H
 ...
 * "mixins".
 */
class P4PointToPointHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a P4PointToPointHelper to make life easier when creating point to
   * point networks.
   */
  P4PointToPointHelper ();
  virtual ~P4PointToPointHelper ()
  {
  }
   ...
   * PointToPointNetDevice created through P4PointToPointHelper::Install.
   */
   ...
   * by P4PointToPointHelper::Install
   */
   ...
   * attributes configured by P4PointToPointHelper::SetChannelAttribute,
...
#endif /* P4_POINT_TO_POINT_HELPER_H */
